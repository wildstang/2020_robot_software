...
public enum WSInputs implements Inputs {
    ...
    DRIVER_SHOULDER_LEFT("driver shoulder left", WSInputType.JS_BUTTON, new WsJSButtonInputConfig(0, 4), false), 
    DRIVER_SHOULDER_RIGHT("Antiturbo", WSInputType.JS_BUTTON, new WsJSButtonInputConfig(0, 5), false), 
    DRIVER_TRIGGER_LEFT("Driver intake", WSInputType.JS_JOYSTICK, new WsJSJoystickInputConfig(0, JoystickConstants.LEFT_TRIGGER), false), 
    ...
    DRIVER_SELECT("Climb reset 1", WSInputType.JS_BUTTON, new WsJSButtonInputConfig(0, 6), false), 
    DRIVER_START("Climb reset 2", WSInputType.JS_BUTTON, new WsJSButtonInputConfig(0, 7), false), 
