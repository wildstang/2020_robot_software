package org.wildstang.navx_data_monitor;
...
public class Robot extends TimedRobot {
    ...
    public Robot() {
        ...
        try {
            ...
            /* See /save/http://navx-mxp.kauailabs.com/guidance/selecting-an-interface/ for details. */
    ...
    public void teleopPeriodic() {
        while (isOperatorControl() && isEnabled()) {
            ...
            /* For more info, see /save/http://navx-mxp.kauailabs.com/installation/omnimount  */
